...
const BLOCKS: { key: BlockKey; label: string; dot: string }[] = [
  ...
  { key: 'concurrency', label: 'Concurrency', dot: 'bg-warning' },
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center gap-3">
        ...
        {dirty && (
          <span className="rounded bg-warning/15 px-1.5 py-0.5 text-[11px] text-amber-600 dark:text-warning/75">
            unsaved
          </span>
        )}
                ...
                <>
                  <Field label="Source">
                    <Input
                      ...
                      className="w-full"
                      placeholder="github / gitlab / linear"
                    />
                  </Field>
                ...
                <>
                  ...
                  <Field label="Review provider">
                    <Input
                      ...
                      onChange={e => set('reviewProvider', e.target.value || undefined)}
                      className="w-full"
                    />
                  </Field>
                </>
              ...
              {selected === 'proof' && (
                <Field label="Command">
                  <Input
                    ...
                    placeholder="bun test apps/backend"
                  />
                </Field>
              )}
              {selected === 'budget' && (
